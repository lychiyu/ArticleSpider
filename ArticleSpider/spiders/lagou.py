...
class LagouSpider(CrawlSpider):
    ...
    def parse_job(self, response):
        ...
        item_loader.add_xpath('company_domain', '//ul[@class="c_feature"]/li[1]/text()')
        item_loader.add_xpath('company_dev', '//ul[@class="c_feature"]/li[2]/text()')
        item_loader.add_xpath('company_scope', '//ul[@class="c_feature"]/li[3]/text()')
